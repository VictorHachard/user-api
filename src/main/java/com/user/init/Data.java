...
public class Data extends AbstractAutowire {
    ...
    public void init() {
        ...
        HtmlText htmlText = htmlTextFacade.newInstance(
                ...
                "<p>Any claim related to YouTube Playlist Checker Website shall be governed by the laws of france without regards to its conflict of law provisions.</p>"
        );
        ...
        "<h2>YouTube Playlist Checker Website Privacy Policy</h2>" +
                "<p>At YouTube Playlist Checker, accessible from https://ypc.yt/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by YouTube Playlist Checker and how we use it.</p>" +
                "<p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>" +
                "<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in YouTube Playlist Checker. This policy is not applicable to any information collected offline or via channels other than this website.</p>" +
                "<h3>1. Consent</h3>" +
                ...
                "</ul>" +
                "<h3>4. Log Files</h3>" +
                "<p>YouTube Playlist Checker follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>" +
                "<h3>5. Cookies and Web Beacons</h3>" +
                "<p>Like any other website, YouTube Playlist Checker uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>" +
                ...
                "<p>YouTube Playlist Checker does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>"
        );
        htmlTextRepository.save(htmlText);
